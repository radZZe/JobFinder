...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fragment_edit_project = navController.findDestination(R.id.editProjectFragment)
